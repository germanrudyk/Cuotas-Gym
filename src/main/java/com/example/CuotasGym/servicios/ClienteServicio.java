...
public class ClienteServicio {
    ...
    @Transactional
    public void crearCliente(String nombre, String telefono, String domicilio, String inicio) throws ParseException, MiException {

        validar(nombre, telefono, domicilio, inicio);
    ...
    public void alta(String id) throws ParseException {
        ...
        cuotaServicio.desReplicar(cliente);
    ...
    public void modificar(String id, String nombre, String telefono, String domicilio, String inicio, String rutinaEspecial) throws MiException, ParseException {
    ...
    private void validar(String nombre, String telefono, String domicilio, String inicio) throws MiException {
